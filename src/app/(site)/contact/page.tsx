...
const CONTACT_INFO = [
  ...
  { icon: Phone, label: "Phone / WhatsApp", value: "024 031 6093" },
  { icon: Mail, label: "Email", value: "hello@adubeagifthub.com" },
];
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <ProductArt category="gift-cards" className="mt-8 aspect-video w-full rounded-2xl" />
          </div>
