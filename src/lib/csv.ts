...
// "Vanilla Bean:#d9a066;Amber Musk:#b5651d" — malformed entries (missing/invalid hex) are
...
export function buildCsvTemplate(): string {
  ...
  const example = [
    ...
    "4.8",
    "32",
    "A hand-packed hamper of treats, a scented candle, and a keepsake card.",
    "Classic:#C9A227",
    "Standard",
    "Hand-packed by our team;Ready to give, no extra wrapping needed",
  ]
